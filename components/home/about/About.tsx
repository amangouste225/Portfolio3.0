          ...
          <div>
            ...
            <Reveal>
              <p>
                ...
                lasting impression. With years of experience in the industry,
                I’ve had the privilege of working with diverse clients, helping
                them achieve their go
              </p>
            </Reveal>
          </div>
        </div>
          ...
          <div>
            <Reveal>
              ...
              >
                ...
                development worlds, with a focus on frontend development.
                I&apos;m passionate about creating beautiful, responsive
            ...
            <Reveal>
              <p className={styles.aboutText}>
                ...
                working together or have any questions, please don&apos;t
